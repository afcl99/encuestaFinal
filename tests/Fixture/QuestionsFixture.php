...
class QuestionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'questions_ibfk_1' => ['type' => 'foreign', 'columns' => ['test_id'], 'references' => ['tests', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
            'collation' => 'utf8_bin'
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'created' => '2020-04-01 10:07:04',
                'modified' => '2020-04-01 10:07:04',
            ],
        ];
        parent::init();
    }
